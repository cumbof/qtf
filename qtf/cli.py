...
def _build_parser() -> argparse.ArgumentParser:
    ...
    fold.add_argument("--force-field", dest="force_field", default=None)
    ...
    fold.add_argument("--ibm-instance-crn", "--ibm-crn", dest="ibm_instance_crn", default=None)
...
def _apply_common_recipe_overrides(recipe: dict, args) -> None:
    ...
    if args.force_field:
        fold["force_field"] = args.force_field
...
def _qtf_argv(args, recipe: dict) -> list[str]:
    ...
    argv += ["--forcefield", str(args.force_field or fold.get("force_field") or "amber")]
