"""QuantumBiophysicsFolder Bryan-dev variant.

Package-structured copy of qtf.core.folder with topology/rebuild/cache/custom-energy
choices ported from bryan_working_branch:QTF/runner.py.
...
class QuantumBiophysicsFolder:
    ...
    def build_output_structure(self, angle_vector):
        ...
        """
        if self.current_stage == 3 and self.stage_backend == "rosetta":
    ...
    def energy_function(self, params, return_terms: bool = False):
        ...
        if self.current_stage == 3 and self.stage_backend == "openmm":
