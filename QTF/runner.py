...
class EnsembleFoldingManager:
    ...
    def prime_circuit(self, target_type='helix'):
        """
        ...
        if target_type == 'helix':
            ...
            return np.random.uniform(-0.8, 0.8, self.folder.n_params)
        ...
        init_guess = np.random.uniform(-0.1, 0.1, self.folder.n_params)
    ...
    def run_ensemble(self, n_runs=5, prime_strategy='mixed'):
        ...
        for i in range(n_runs):
            ...
            if strat == 'random':
                ...
                start_params = self.prime_circuit(target_type=strat)
