...
#SBATCH --job-name=qtf_5awl_rosetta
#SBATCH --output=../logs/qtf_5awl_rosetta_%A_%a.out
#SBATCH --error=../logs/qtf_5awl_rosetta_%A_%a.err
...
SEQUENCE="YYDPETGTWY"
REFERENCE_PDB_ID="../references/5AWL.pdb"
